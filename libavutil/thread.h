...
#include "config.h"
    // 这几个宏定义在 config.h文件中，config.h是编译后自动生成的
        ...
        // pthread_once_t 是一个 long 整形，标记初始化是否完成
        // 文件路径 \mingw64\x86_64-w64-mingw32\include\pthread.h
        //      或 \compat\w32pthreads.h
        //      或 \compat\os2threads.h (结构体)
        #define AVOnce pthread_once_t
        #define AV_ONCE_INIT PTHREAD_ONCE_INIT 
        
        /**
         * 这个宏定义方法是注册各种组件方法最终调用的方法。
         * pthread_once方法保证仅初始化一次,线程安全,比用信号量效率更高
         * 定义在 \compat\w32pthreads.h (或\compat\os2threads.h)
         *    或  \mingw64\x86_64-w64-mingw32\include\pthread.h
         */
